import EditUserNotesForm from "./form/EditUserNotesForm";
import { Button } from "@/components/ui/button";

export default function UserNoteList({ data, page, setPage, meta }) {
  return (
    <div>
      {data && data.length > 0 ? (
        <>
        ...
        <div className="w-full text-center py-8">
          <p className="text-gray-500">
            No user found. Add a new user to get started.
          </p>
        </div>
      )}
    </div>
