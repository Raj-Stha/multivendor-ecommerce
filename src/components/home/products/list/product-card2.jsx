    ...
    >
      ...
      >
        ...
        <Link
          ...
          className="p-1 sm:p-2 md:p-4 flex-1 flex flex-col bg-white"
        >
      ...
      {/* Quick View Modal */}
      <DialogContainer>
        <DialogContent className="relative jost-text flex flex-col border dark:bg-black bg-white lg:w-[900px] w-[95%] max-h-[80vh] mx-auto overflow-hidden">
