      ...
      <main className="flex flex-col items-center justify-center min-h-screen px-6 text-center bg-gradient-to-b from-primary/5 via-secondary/10 to-background relative overflow-hidden jost-text">
        ...
        >
          <Link href="/">
            <Button
              size="lg"
              className="px-8 py-4 cursor-pointer text-lg rounded-full bg-primary text-white hover:bg-primary/90 flex items-center gap-2 shadow-xl hover:shadow-primary/30 transition-all duration-300"
            >
              <Home size={20} />
              Go Back Home
            </Button>
